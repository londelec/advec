...
#define ADVANTECH_EC_HWMON_VER     "1.08"
#define ADVANTECH_EC_HWMON_DATE    "10/11/2018"
...
// TPC-1751T-E3AE, TPC-1051WP-E3AE, TPC-1551WP-E3AE, TPC-1782H-433AE, 
// UNO-1483G-434AE, UNO-2483G-434AE, UNO-3483G-374AE, UNO-2473G-JxAE
...
static ssize_t get_ec_temp2_input(struct device *dev,struct device_attribute *attr,char *buf)
{
	...
	else if(!adspname_detect(BIOS_Product_Name,"UNO-2473G-J?AE"))
	{
		read_acpi_value(0x61,&value);
		return sprintf(buf,"%d\n",1000*value);
	}
